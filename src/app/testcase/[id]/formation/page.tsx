// app/testcase/[id]/formation/page.tsx — the Formation tab.
// (Moved from /formation/[id], which now redirects here.)
'use client';

import React, { useEffect, useState, useCallback } from 'react';
import { useParams } from 'next/navigation';
import {
  Title, Text, Group, Stack, Button,
  Loader, Center, Alert, Card, Divider,
...
export default function FormationPlaybackPage() {
  ...
  // The case shell (layout.tsx) provides breadcrumb, title, and tabs; this
  // page renders only the playback content.
  return (
    <Stack gap="md">
